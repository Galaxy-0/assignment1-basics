...
def get_tokenizer(
    ...
    """
    # Connect tests to the student's Tokenizer implementation.
...
def run_train_bpe(
    ...
    **kwargs,
    ...
    return train_bpe.train_bpe(input_path=input_path, vocab_size=vocab_size, special_tokens=special_tokens)
